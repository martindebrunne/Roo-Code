	...
	*/
	...
	async getStateToPostToWebview(): Promise<ExtensionState> {
		...
		return {
			...
			alwaysAllowMcpRead: alwaysAllowMcpRead ?? false,
			alwaysAllowMcpWrite: alwaysAllowMcpWrite ?? false,
			alwaysAllowMcpUnspecified: alwaysAllowMcpUnspecified ?? false,
	...
	> {
		...
		return {
			...
			alwaysAllowMcpRead: stateValues.alwaysAllowMcpRead ?? false,
			alwaysAllowMcpWrite: stateValues.alwaysAllowMcpWrite ?? false,
			alwaysAllowMcpUnspecified: stateValues.alwaysAllowMcpUnspecified ?? false,
